     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         for (var i = 0; i < tipuesearch_in.pages.length; i++)
                         {
                              ...
                              for (var f = 0; f < d_w.length; f++)
                              {
								   ...
								   if (tipuesearch_in.pages[i].internal_loc.search(pat) != -1)
                                   {
                                        score -= (1500 - i);
                                   }
                              ...
                              if (score < 10000000)
                              {
                                   found[c++] = score + '^' + tipuesearch_in.pages[i].title + '^' + s_t + '^' + tipuesearch_in.pages[i].loc + '^' + tipuesearch_in.pages[i].internal_loc;
                              }
                         }                         
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {
                                        out += '<div id="tipue_search_content_title"><a class="search-jump" href="' + fo[3] + '"' + tipue_search_w + '>' +  fo[1] + '</a></div>';
                                        ...
                                        if (set.showURL)
                                        {
                                            out += '<div id="tipue_search_content_loc"><a class="search-jump" href="' + fo[3] + '"' + tipue_search_w + '>' + fo[4] + '</a></div>';
                                        }
                                   }
                                   l_o++;     
                              }
                    ...
                    // additions for in page
					$('#bottomContainer').hide();
					out = "<h3 class='blue'>Search results</h3>"+ out;
                    
                    
                    $('#search-container').html(out);
                    ...
                    $(function() {
						$('.search-jump').click( function(e){
							...
							var jump = target.substring( target.indexOf( "#" ) )
							...
							if( current.indexOf( target ) == 0 ) {
								...
								$(window).scrollTop( $(jump ).offset().top - 150 );
								e.preventDefault();
							}
							else {
								
								// do normal, doesnt link right but...
							}
